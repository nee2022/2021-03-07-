        ...
        <div class="right-con-top">
          <div class="textBox">
            ...
            <el-input
              ...
              v-model="input1"
              clearable
              @keyup.enter.native="getInputMes"
            ></el-input>
          </div>
            ...
            <el-table :data="tableData" stripe style="width:100%">
              <el-table-column>
                <template slot-scope="scope">
                  <div
                    class="leftBox"
                    :class="{ BGactive: scope.row.id == isActive }"
                  ...
                  >
                    ...
                    <div
                      class="leftBox-con"
                      @click="getParksMes(scope.row.id), scope.row.station"
                    >
                      <div class="parkName">
                        {{ scope.row.name }}
                      </div>
                    ...
                    <template v-else>
                      <div
                        style="text-align: right;width: 20%;font-size: 30px;"
                      >
                        ...
                      </div>
                    </template>
